...
window.addEventListener('DOMContentLoaded', () => {
  ...
  b1.addEventListener('click', () => {
    dialog.showOpenDialog({ properties: ['openFile'] }).then((response) => {
      ...
      const ls = spawn("py", ['../python stuff/pixel.py', '--vidPath', '../attention-zero/video/videos/Renai Circulation.mp4', '--percentile', '30', '--vid2height', '480', '--vid2width', '360', '--attentionSpan', '300'])
